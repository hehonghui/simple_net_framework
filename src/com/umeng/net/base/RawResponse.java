 ...
 * @author mrsimple
 */
public class RawResponse extends BasicHttpResponse {

    public byte[] rawData = new byte[0];

    public RawResponse(StatusLine statusLine) {
        super(statusLine);
    }

    public RawResponse(ProtocolVersion ver, int code, String reason) {
