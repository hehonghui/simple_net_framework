/**
 *
 *	created by Mr.Simple, Dec 20, 20142:19:11 PM.
...
public class JsonRequest extends Request<JSONObject> {
    ...
    public JsonRequest(HttpMethod method, String url, Map<String, String> params,
            com.umeng.net.base.Request.RequestListener<JSONObject> listener) {
        super(method, url, params, listener);
    }

    @Override
    public JSONObject parseResponse(RawResponse response) {
